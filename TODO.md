...
- [ ] Train full-data CTC baseline: `python train_baseline_ctc.py --data-config <cfg.json> --output-directory runs/baseline_full`.
...
- [ ] Train JEPA pretraining with default augmentations: `python train_jepa_pretrain.py --data-config <cfg.json> --output-directory runs/jepa_pretrain_default`.
